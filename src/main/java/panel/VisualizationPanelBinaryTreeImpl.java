...
import javax.swing.*;
import java.awt.*;
public class VisualizationPanelBinaryTreeImpl extends JPanel {

    private BinaryTree binaryTreeInstance;

     public VisualizationPanelBinaryTreeImpl(BinaryTree tree)
    {
        this.binaryTreeInstance = tree;
    }

    @Override
    protected void paintComponent(Graphics g) {
             super.paintComponent(g);
             if (binaryTreeInstance != null && binaryTreeInstance.root != null) {
                 drawNode(g, binaryTreeInstance.root, getWidth() / 5, 50);
             }
    }
